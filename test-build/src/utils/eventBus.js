...
exports.GameEvents = exports.EventBus = void 0;
var EventBusClass = /** @class */ (function () {
     ...
     */
    EventBusClass.prototype.on = function (eventName, callback) {
        var _this = this;
     ...
     * @returns Unsubscribe function
     */
    EventBusClass.prototype.once = function (eventName, callback) {
        var _this = this;
     ...
     */
    EventBusClass.prototype.off = function (eventName, callback) {
        if (!this.events[eventName])
            return;
        // Check if this was a 'once' event
        var wrapper = this.onceEvents.get(callback);
        var targetCallback = wrapper || callback;
        this.events[eventName] = this.events[eventName].filter(function (cb) { return cb !== targetCallback; });
        if (wrapper) {
     ...
     */
    EventBusClass.prototype.emit = function (eventName) {
        var args = [];
        ...
        var handlers = __spreadArray([], this.events[eventName], true);
        handlers.forEach(function (callback) {
            try {
                callback.apply(void 0, args);
            }
            catch (error) {
                console.error("Error in event handler for \"".concat(eventName, "\":"), error);
            }
        });
    };
    /**
     ...
     */
    EventBusClass.prototype.clear = function (eventName) {
        if (eventName) {
            delete this.events[eventName];
        }
        else {
     ...
     */
    EventBusClass.prototype.getEventNames = function () {
     ...
     */
    EventBusClass.prototype.listenerCount = function (eventName) {
     ...
     */
    EventBusClass.prototype.hasListeners = function (eventName) {
